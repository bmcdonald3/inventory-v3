...
var rootCmd = &cobra.Command{
	Use:   "inventory-v3",
	Short: "",
	Long:  `inventory-v3 - A Fabrica-generated OpenCHAMI service`,
	RunE:  runServer,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the inventory-v3 server",
	Long:  `Start the inventory-v3 HTTP server with the configured options`,
	RunE:  runServer,
}
...
func init() {
	...
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.inventory-v3.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName(".inventory-v3")
	}

	// Environment variables
	viper.SetEnvPrefix("INVENTORY-V3")
	viper.AutomaticEnv()
...
func runServer(cmd *cobra.Command, args []string) error {
	...
	if eventConfig.EventTypePrefix == "" {
		eventConfig.EventTypePrefix = "inventory-v3.resource"
	}
...
var versionCmd = &cobra.Command{
	...
	Long:  `Print the version number of inventory-v3`,
