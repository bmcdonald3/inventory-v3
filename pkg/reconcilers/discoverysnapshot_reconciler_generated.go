...
// This file provides the generated boilerplate for DiscoverySnapshot reconciler.
//
...
//
// To customize reconciliation logic, edit discoverysnapshot_reconciler.go
package reconcilers
...
// DiscoverySnapshotReconciler reconciles DiscoverySnapshot resources.
//
// This reconciler:
//   - Observes DiscoverySnapshot resources and updates their Status
...
//
// The implementation of reconcileDiscoverySnapshot() is in discoverysnapshot_reconciler.go
type DiscoverySnapshotReconciler struct {
	reconcile.BaseReconciler

	// Custom fields are defined in discoverysnapshot_reconciler.go
}

// NewDefaultDiscoverySnapshotReconciler creates a default DiscoverySnapshot reconciler.
//
...
//
// Returns:
//   - *DiscoverySnapshotReconciler: Initialized reconciler
func NewDefaultDiscoverySnapshotReconciler(client reconcile.ClientInterface, eventBus events.EventBus) *DiscoverySnapshotReconciler {
	return &DiscoverySnapshotReconciler{
...
// Reconcile brings DiscoverySnapshot to desired state.
//
// This method is called:
//   - When a DiscoverySnapshot resource is created/updated/deleted
...
//   - resource: The DiscoverySnapshot resource to reconcile
//
// Returns:
